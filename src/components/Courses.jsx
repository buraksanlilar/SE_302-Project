...
function Courses() {
  ...
  const handleAddCourse = () => {
    ...
    if (courses.some(
      ...
      alert(`Conflict detected: Another course is scheduled in ${newCourseData.classroom} on ${newCourseData.day} at ${newCourseData.hour}.`);
      return;
    }
  ...
  const handleEditClassroom = () => {
    ...
    if (courses.some(
      ...
      alert(`Conflict detected: Another course is scheduled in ${updatedCourse.classroom} on ${updatedCourse.day} at ${updatedCourse.hour}.`);
      return;
    }
  ...
  return (
    <div className="container">
      ...
      {editCourse && (
        <div className="edit-classroom">
          <h4>Edit Classroom for {editCourse.courseName}</h4>
          <select
            value={newClassroomForEdit}
            onChange={(e) => setNewClassroomForEdit(e.target.value)}
          >
            <option value="">Select Classroom</option>
          ...
          <button onClick={handleEditClassroom}>Save Classroom</button>
        </div>
      )}
    </div>
  );
